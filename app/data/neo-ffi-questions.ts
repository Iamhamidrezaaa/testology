...
export const getNeoFfiInterpretation = (scores: { [key: string]: number }): string => {
  ...
  let result = "نتایج تست شخصیت NEO-FFI شما:\n\n"
...
export const calculateNeoFfiScores = (answers: string[]): { [key: string]: number } => {
  const scores = {
    "Openness": 0,
    "Conscientiousness": 0, 
    "Extraversion": 0,
...
export default neoFfiQuestions
